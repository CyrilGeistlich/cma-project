...
```{r read_context_data, warning = FALSE, message=FALSE}
# read context data
...
```{r post_cleaning_data, warning = FALSE, message=FALSE}
...
```{r load_data_2 , warning = FALSE, message=FALSE}
...
```{r filtering_classes, warning = FALSE, message=FALSE}
...
```{r sampling_interval, warning = FALSE, message=FALSE}
...
```{r visualise_parameters, warning = FALSE, message=FALSE}
...
```{r velocity_threshold, warning = FALSE, message=FALSE}
...
```{r acceleration_threshold, warning = FALSE, message=FALSE}
...
```{r acceleration_threshold2, warning = FALSE, message=FALSE}
...
```{r start_classification, warning = FALSE, message=FALSE}
# Set seed for reproducibility
set.seed(100)
...
```{r show_class_distribution, warning = FALSE, message=FALSE}
# Show class distribution
...
```{r show_class_distribution2, warning = FALSE, message=FALSE}
# Show class distribution
