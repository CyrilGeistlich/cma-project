...
posmo_micha_truth_csv <- read.delim("data/labelled/posmo_20230502_to_20230613_labelled.csv",sep=",") 
```
...
process_posmo_data <- function(posmo_data) {
