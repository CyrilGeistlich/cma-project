...
```{r}
pool_sf1 <- process_posmo_data(posmo_pool_1)
pool_sf2 <- process_posmo_data(posmo_pool_2)
pool_sf3 <- process_posmo_data(posmo_pool_3)

mapview(tail(pool_sf1, 612), zcol="transport_mode")
mapview(tail(pool_sf2, 20000), zcol="transport_mode") 
mapview(pool_sf3, zcol="transport_mode")
```
